...
<form method="POST" action="" enctype="multipart/form-data">
    ...
    <hr>
    <label for="prdName"><b>Product ID:</b></label>
    <input type="text" name="prdID" value="<?php
    if(!empty($data1)){
    ...
    <hr>
    <button type="submit" class='add_prd btn btn-warning left-margin' name="update_prd" value="save">Update</button>
    <br>
