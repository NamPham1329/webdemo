        ...
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                foreach ($data as $item){
                    ...
                    <td style="width: 5%;"><a href="/webdemo/admin/category/updateCategory/?id='.$item['id'].'"><button class="btn btn-warning left-margin">Edit</button></a></td>
                    <td>
                        <form method="POST">
...
<div class="back">
		<a href="/webdemo/admin/category/insertCategory" class="btn btn-warning left-margin">New</a>
</div>
                </div>
            </div>
        </div>
