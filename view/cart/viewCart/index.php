...
<form method="POST">
    <div class="container padding-bottom-3x mb-1">
                    ...
                    <tr> 
                        ...
                        <td class="text-center">
                            <div class="count-input">
                                <form>
                                    <input style="width: 50%;" type="text" name="quantity" value="<?php echo $item['quantity']?>">
                                </form>
                            </div>
                        </td>
        ...
        <div class="shopping-cart-footer">
            ...
            <div class="column">
                <button class="btn btn-primary" type="submit" name="update" value="<?php echo $data[0]['order_id'];?>">Clear Cart</button>
